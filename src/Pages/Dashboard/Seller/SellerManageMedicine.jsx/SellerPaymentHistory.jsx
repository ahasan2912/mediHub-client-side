...
const SellerPaymentHistory = () => {
    ...
    const totalPayment = payments.reduce((total, amount) => total + parseInt(amount.price), 0);
    ...
    return (
        <div className="p-10 max-w-7xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 sm:gap-0">
                <h1 className="text-2xl sm:text-3xl font-semibold">Total payments: {totalPayment}</h1>
                <div>
